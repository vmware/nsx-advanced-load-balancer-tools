...
$ chmod a+x run.sh
./run.sh -h
-v string    specify AVI_VERSION, default value: 18.2.2
...
```
$ ./run.sh -c avitools-list or ./run.sh or ./run.sh -v 18.2.2 -c avitools-list
```
## To show the commands supported by avitools 18.2.2 version of container
```
$ ./run.sh -v 18.2.2 -c avitools-list
```
...
$ ./run.sh -v 18.2.2 -d /home/aviuser -c "f5_converter.py -h"
$ ./run.sh -v 18.2.2 -d /home/aviuser -c "f5_converter.py -f <filename>"
```
...
```
$ ./run.sh -v 18.2.2 -c bash -d /home/aviuser/workspace -b
$ docker exec -it avitools bash
```
## Docker - "-n" use host networking, supported in both modes (background and foreground/cmd mode).
```
$ ./run.sh -v 18.2.2 -n -c bash -d /home/aviuser/workspace -b
$ ./run.sh -v 18.2.2 -n -d /home/aviuser -c "f5_converter.py -h"
```
...
```
cd build
docker build -t avinetworks/avitools:18.2.2 .
```
